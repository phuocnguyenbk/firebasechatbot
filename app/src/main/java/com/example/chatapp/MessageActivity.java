...
import com.example.chatapp.Constant.NodeName;
...
public class MessageActivity extends AppCompatActivity {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!msg.equals("")) {
                    ...
                    Toast.makeText(MessageActivity.this, "You can't send the empty mess", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
    ...
    private void sendMessage(String sender, final String receiver, String message) {
        ...
        final DatabaseReference chatRef = FirebaseDatabase.getInstance().getReference(NodeName.CHAT_LIST_NODE)
                .child(sender)
                .child(receiver);
